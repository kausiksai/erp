...
function DCDetails() {
  ...
  const filtered = searchLower
    ? records.filter((r) => {
        const hay = [
          r.po_number, r.dc_no, r.ord_no, r.item, r.description, r.supplier, r.supplier_display_name,
          r.sf_code, r.grn_no, r.open_order_no, r.source, r.material_type, r.received_item,
        ].join(' ').toLowerCase()
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await fetch(apiUrl('delivery-challans'), {
